...
object DataExtractor extends App {
  ...
  val content: String = Files
    .lines(Paths.get(
      "/Users/xiachen/IdeaProjects/insuranceqa-corpus-zh/corpus/pairs/iqa.vocab.json"))
  ...
  val questions: stream.Stream[String] = Files.lines(Paths.get(
    "/Users/xiachen/IdeaProjects/insuranceqa-corpus-zh/corpus/pairs/iqa.train.json"))

  outputQuestion(questions, id2word)

  def outputQuestion(qs: stream.Stream[String],
                     id2word: Map[Int, String]): Unit = {
