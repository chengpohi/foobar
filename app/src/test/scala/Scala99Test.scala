...
class Scala99Test extends FlatSpec with Matchers {
  ...
  it should " list" in {
    ...
    scala99 pack List(1, 2, 2, 3, 3) should equal(
      List(List(2, 2), List(1), List(3, 3)))
    List(Array(2, 2), Array(1, 1), Array(2, 3)) should contain(Array(2, 2))
    scala99 encode List(1, 2, 2, 3, 3) should equal(
      List((2, 2), (1, 1), (2, 3)))
    scala99 encode List("1", "2", "2", "3", "3") should equal(
      List((2, "2"), (1, "1"), (2, "3")))
    scala99 encodeModified List(1, 2, 2, 3, 3) should equal(
      List((2, 2), 1, (2, 3)))
    scala99 decodeModified List((2, 2), (1, 1), (2, 3)) should equal(
      List(2, 2, 1, 3, 3))
    scala99 duplicate List(1, 2, 2, 3, 3) should equal(
      List(2, 2, 2, 2, 1, 1, 3, 3, 3, 3))
    scala99 duplicate (List(1, 2, 2, 3, 3), 3) should equal(
      List(2, 2, 2, 2, 2, 2, 1, 1, 1, 3, 3, 3, 3, 3, 3))
    scala99 remove (List(1, 2, 2, 3, 3, 4), 3) should equal(List(1, 2, 3, 3))
    scala99 split (List(1, 2, 2, 5, 3, 4), 3) should equal(
      (List(1, 2, 2), List(5, 3, 4)))
    scala99 rotate (List(1, 2, 3, 4, 5), 3) should equal(List(4, 5, 1, 2, 3))
    scala99 removeByIndex (List(1, 2, 3, 4, 5), 3) should equal(
      List(1, 2, 4, 5))
    scala99 insert (List(1, 2, 3, 4, 5), 8, 3) should equal(
      List(1, 2, 3, 8, 4, 5))
    ...
    scala99 combination (List(1, 2, 3, 4, 5), 3) should equal(
      List(List(1, 2, 3),
           List(1, 2, 4),
           List(1, 2, 5),
           List(1, 3, 4),
           ...
           List(2, 4, 5),
           List(3, 4, 5)))
    scala99 group (List(1, 2, 3, 4, 5), List(2, 2, 1)) should equal(
      List(
        List(List(1, 2), List(3, 4), List(5)),
        List(List(1, 2), List(3, 5), List(4)),
        List(List(1, 2), List(4, 5), List(3)),
        List(List(1, 3), List(2, 4), List(5)),
        List(List(1, 3), List(2, 5), List(4)),
        List(List(1, 3), List(4, 5), List(2)),
        List(List(1, 4), List(2, 3), List(5)),
        List(List(1, 4), List(2, 5), List(3)),
        List(List(1, 4), List(3, 5), List(2)),
        List(List(1, 5), List(2, 3), List(4)),
        List(List(1, 5), List(2, 4), List(3)),
        List(List(1, 5), List(3, 4), List(2)),
        List(List(2, 3), List(1, 4), List(5)),
        List(List(2, 3), List(1, 5), List(4)),
        List(List(2, 3), List(4, 5), List(1)),
        List(List(2, 4), List(1, 3), List(5)),
        List(List(2, 4), List(1, 5), List(3)),
        List(List(2, 4), List(3, 5), List(1)),
        List(List(2, 5), List(1, 3), List(4)),
        List(List(2, 5), List(1, 4), List(3)),
        List(List(2, 5), List(3, 4), List(1)),
        List(List(3, 4), List(1, 2), List(5)),
        List(List(3, 4), List(1, 5), List(2)),
        List(List(3, 4), List(2, 5), List(1)),
        List(List(3, 5), List(1, 2), List(4)),
        List(List(3, 5), List(1, 4), List(2)),
        List(List(3, 5), List(2, 4), List(1)),
        List(List(4, 5), List(1, 2), List(3)),
        List(List(4, 5), List(1, 3), List(2)),
    ...
    scala99 goldBanchEvenList (9, 20) should equal(
      List((3, 7), (5, 7), (3, 11), (3, 13), (5, 13), (3, 17)))
    ...
    scala99 countLeaves Node(Some(Node(Some(left), Some(right), 1, Some(""))),
                             Some(Node(Some(left), Some(right), 1, Some(""))),
                             1,
                             Some("")) should equal(4)
